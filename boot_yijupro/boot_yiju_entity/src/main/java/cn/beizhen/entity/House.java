...
public class House {
    ...
    private String house_area_code;
    //	城市编码、
...
//    private List<HouseImg> list;
    ...
    public House(Integer id, Double price, String district, String house_area_code, String house_city_code, Integer state, String address, Integer user_id, Integer housesize, String picture, Integer renttype, String floot, Date house_createYear, String houseType, int categoryType, String rname, String houseIntroduce, Integer collectionCount, Integer housepd, Integer housepush, String housefczimg, Integer housepushpd, Double housepushmoney, Integer adminupdate, Date updateTime) {
        this.id = id;
        this.price = price;
    ...
    public String getHouse_area_code() {
        return house_area_code;
    }

    public void setHouse_area_code(String house_area_code) {
        this.house_area_code = house_area_code;
    }
