...
<html>
  <head>
    ...
    <title>My JSP 'select_list.jsp' starting page</title>
		...
		<div class="contant">
			...
			<div class="xinxi clearfix">
				<div class="left">
					...
					<ul id="route">
						<c:forEach items="${house_categoryType}" var="house" >
							<li>
								<div class='img'>
							...
							<table class="gridtable" style="width:100%;text-align: center;">
								<tr>
									<td width="10%" if="${ByConditionPage.hasPreviousPage}">
										<a href="house/categoryType?id=${categoryType}">首页</a>
									</td>
									<td width="10%" if="${ByConditionPage.hasPreviousPage}">
										<a href="house/categoryType?id=${categoryType}&pageIndex=${ByConditionPage.prePage}">上一页</a>
									</td>
									...
									<td width="10%" if="${ByConditionPage.hasNextPage}">
										<a href="house/categoryType?id=${categoryType}&pageIndex=${ByConditionPage.nextPage}">下一页</a>
									</td>
									<td width="10%" if="${ByConditionPage.hasNextPage}">
										<a href="house/categoryType?id=${categoryType}=&pageIndex=${ByConditionPage.pages}">尾页</a>
									</td>
								</tr>
							</table>
